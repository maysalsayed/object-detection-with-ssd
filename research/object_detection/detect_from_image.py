...
def run_inference(model, category_index, image_path):
    ...
    with open('object_areas.txt', 'a') as f:  # Open the file in append mode
        ...
        for i_path in image_paths:
            ...
            array=[]
            for box, class_id, score in zip(output_dict['detection_boxes'], output_dict['detection_classes'], output_dict['detection_scores']):
            ...
            for box, class_id, score in zip(output_dict['detection_boxes'], output_dict['detection_classes'], output_dict['detection_scores']):
                ...
                if score > 0.5  :
                        ...
                        # f.write(f"Class: {class_name}, Area: {area:.2f}, Confidence Score: {score:.4f}")
    ...
    #         output_dict['detection_scores'],
    #         category_index,
    #         instance_masks=output_dict.get('detection_masks_reframed', N   one),
    #         use_normalized_coordinates=True,
    #         line_thickness=8)
    #     plt.imshow(image_np)
    #    # plt.show()
